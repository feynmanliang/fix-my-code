<?php
if (isset($_POST['lang']) && $_POST['lang'] == 'Natural_Language') {
    include 'natural_language.php';
    die();
}
$title = "Practice";
include 'header.php';
...
<span id="complete" style="display: none;">
    <center style="font-size: 16.5px;">Congratulations!<br /><br />You have completed all the generated problems from this git repository!
    <br /><br />
...
<span id="part1" style="display: none;">
    <center style="font-size: 16.5px;">Click on the violating line.<br /><small><b>Note:</b> Leading spaces/tabs are represented as &rarr;.</small></center><br />
    <div class="container">
    <pre id="code"><!--
...
<center id="part2_msg" style="font-size: 16.5px;"></center>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                            <a href="#">
                                                <div class="card red summary-inline" id="click1">
                                                    <div class="card-body clicky">
                                                        <div class="content nf">
                                                            ...
                                                            <div class="sub-title" id="ans1"> </div>
                                                        </div>
                                                        <div class="clear-both"></div>
                                                    </div>
                                                </div>
